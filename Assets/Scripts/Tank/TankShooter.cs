...
{
    public GameObject firePoint; //Use this in space for instantiating cannon balls
    ...
    public void Shoot()
    {
        ...
        // The cannnon ball needs some data: Who fired it, and how much damage will it do?
